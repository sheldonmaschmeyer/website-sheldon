  ...
  <div class="container-fluid p-0">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="skills">
      <div class="w-100">
        ...
        <p><ul>
        <li>Computer/Network Security: Burp, Wireshark, and Packet Tracing.</li>
        <li>Windows (Batch) and Linux (Batch). </li>
        <li>OS Kernel programming on Linux.</li>
        <li>Databases: Oracle SQL, mySQL, MongoDB.</li>
        <li>Git; using GitHub for collaboration and version control.</li>
        <li>XML, JSON, CSS, JavaScript, PHP, HTML5. Used Bootstrap-5 and additional frameworks. </li>
        <li>Favorite IDE: Dreamweaver (Windows) and Wappler (Linux). </li>
        <li>OpenSource Matomo (Formally PIWIK)</li>
        <li>Google Analytics</li>
        <li>Microsoft Internet Information Services (IIS)</li>
        <li>Linux with Apache Server (for testing before going live)</li>
        <li>MS Office programs including advanced skills with Excel.</li>
        <li>Adobe Photoshop and Premier.</li>
        </ul></p></div>
