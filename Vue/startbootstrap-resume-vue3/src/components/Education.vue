      ...
      <div class="w-100">
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            ...
            <a class="subheading mb-3 summary" href="#compSci" data-bs-toggle="collapse" style="text-decoration:none;">
              Carleton University
            </a>
        ...
        <div class="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
          <div class="resume-content">
            ...
            <a class="subheading mb-3 summary" href="#sci" data-bs-toggle="collapse" style="text-decoration:none;">
              Carleton University
            </a>
